...
(function (root, factory) {
    ...
    HeatMap.prototype = {
        ...
        _init: function () {
            ...
            this._circle_length = this._circle.length;
        ...
        _heat: function (pos, c) {
            ...
            var i;
            var original_points = this._original_points;
            var circle = this._circle;
            var l = this._circle_length;
            var size = this._size;
            var p;
            var ipos;
        ...
        render: function () {
            ...
            var img_data = this._ctx.createImageData(width, height);
            var pix = img_data.data;
            var size = this._size;
            var flat_data = this._flat_points;
